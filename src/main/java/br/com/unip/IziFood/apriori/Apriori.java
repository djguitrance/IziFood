package br.com.unip.IziFood.apriori;
...
class Apriori {
	...
	static void getDatabase() throws Exception {
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/iziFood?useTimezone=true&serverTimezone=UTC&useSSL=false");
		Statement s = con.createStatement();
		
		ResultSet rs = s.executeQuery("SELECT * FROM historico_has_ingrediente;");
